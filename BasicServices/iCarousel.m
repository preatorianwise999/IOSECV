...
#define DECELERATION_MULTIPLIER 20.0
...
{   
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeCoverFlow2:
        {
            CGFloat tilt = [self valueForOption:iCarouselOptionTilt withDefault:0.05f];
            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:0.27];
            ...
            CGFloat x = (clampedOffset * 0.4 * tilt + offset * spacing) * _itemWidth;
            CGFloat z = fabs(clampedOffset) * -_itemWidth * 0.1;
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gesture shouldReceiveTouch:(UITouch *)touch
{
    ...
    {
        NSInteger itemIndex = [self indexOfItemView:[self itemViewAtPoint:[touch locationInView:_contentView]]];
